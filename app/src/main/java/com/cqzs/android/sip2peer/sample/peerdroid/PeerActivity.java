package com.cqzs.android.sip2peer.sample.peerdroid;
...
import com.cqzs.android.sip2peer.sample.R;


/**
 * Class <code>PeerActivity</code>
 * is the main activity where a new peer object is instantiated and a ping message is sent.
 *
...
public class PeerActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //create menu
        MenuItem configuration = menu.add(Menu.NONE, MENU_CONFIG, 1, getString(R.string.config));
